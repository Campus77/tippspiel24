...
function start_countdown() {
	...
	function countdown() {
		$('div.game_open').each( function() {
			...
			if (diffMS < 0 ) {
				$(this).removeClass('game_open').addClass('game_closed');
...
function handleButtonState()
{
	...
	var gameDiv = btnSubmit.parent().parent();
	var bets = gameDiv.find('.goal');
...
$(document).ready(function(){
	...
	var top = $('div#game.game_open:first').offset().top - pane.offset().top - offset;
	pane.scrollTo(top);
	

	$("div#game.game_open").on("click", function() {
	...
	$("div#game").on("click", "div#team1_plus", function(e) {
		increaseScore($(this), true);
		return false;
	});

	$("div#game").on("click", "div#team1_minus", function(e) {
		decreaseScore($(this), true);
		return false;
	});

	$("div#game").on("click", "div#submitBet", function(e) {
		var btnSubmit = $("div#submitBet");
		...
		$.post('submitBet.php', { game: gid, bet1: b1, bet2: b2 }, function(data) {
	...
	$("div#game").on("click", "div#team2_plus", function(e) {
		increaseScore($(this), false);
		return false;
	});

	$("div#game").on("click", "div#team2_minus", function(e) {
